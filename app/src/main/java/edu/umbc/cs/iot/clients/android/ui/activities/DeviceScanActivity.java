...
public class DeviceScanActivity extends ActionBarActivity {
    ...
    private ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            Toast.makeText(getApplicationContext(),result.getDevice().getAddress()+" "+result.getRssi()+" "+result.getDevice().fetchUuidsWithSdp()+" "+result.getScanRecord().getServiceUuids().toString(),Toast.LENGTH_LONG).show();
