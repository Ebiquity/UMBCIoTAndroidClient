...
public class AlternateMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCheckAgainButton = (Button) findViewById(R.id.checkAgainButton);
        mCheckAgainButton.setOnTouchListener(mDelayHideTouchListener);
        mCheckAgainButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainActivityLaunchIntent = new Intent(v.getContext(), MainActivity.class);
